...
5. 배포 후 개선: 이미지 WebP 최적화(pillar/value/write/voyage/case ~수 MB, 빌드 청크 경고), 미사용 파일 정리(search-demo.webm, ship.png, sea.png, 원본 mp4), 파비콘 404, 모바일 실기기 검증, Vercel 중복 프로젝트 정리(miki-ruby=흰 화면, gmcms226-web/portfolio 빈 저장소).
